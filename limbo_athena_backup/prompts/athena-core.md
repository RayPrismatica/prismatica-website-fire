...
**IMPORTANT - Dynamic Content**: The website features AI-generated content that updates every 6 hours based on current news. When users ask about what they're reading or reference specific insights on the site, check `scripts/knowledge/pages/dynamic-content.md` for the currently live content. This file contains all the news insights, service descriptions, and market observations users are actually seeing.
