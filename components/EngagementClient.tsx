  ...
  return (
    <PageLayout>
      <section id="consulting" className="section active">
        ...
        <p><InlineObservation content={marketObservation} /></p>
        ...
        <p><DynamicServiceDescription content={serviceDescription} /></p>
        ...
        <p><DynamicESIDescription content={esiDescription} /></p>
        ...
        <p><DynamicAgencyDescription content={agencyDescription} /></p>
        ...
        <p><DynamicKSODescription content={ksoDescription} /></p>
        ...
        <p><DynamicTransactionDescription content={transactionDescription} /></p>
        ...
        <p><DynamicTriptychDescription content={triptychDescription} /></p>
