  ...
  return (
    <>
      ...
      <nav className={`sidebar ${isMobileMenuOpen ? 'mobile-open' : ''} ${isInitialLoad ? 'no-transition' : ''} ${isHomepage ? 'homepage-mode' : ''}`}>
        ...
        {/* Mobile-positioned footer links (visible on mobile, just above Athena banner) */}
        <div className="mobile-footer-links" style={{ marginBottom: '24px' }}>
          ...
          <p style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '9px', color: '#999', margin: '0', textAlign: 'center' }}>© 2025 Prismatica Labs Limited</p>
        </div>
        <div className="sidebar-logo sidebar-logo-section" style={{ flexShrink: 0, paddingBottom: 0 }}>
          ...
          <p className="desktop-copyright" style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '9px', color: '#999', margin: '0', textAlign: 'left' }}>© 2025 Prismatica Labs Limited</p>
        </div>
      </nav>
    </>
  );
