  ...
  return (
    <PageLayout>
      <section id="privacy" className="section active">
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>What we collect</h3>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px' }}>When you use Athena (our AI chat)</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>When you contact us</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>When you enquire about products</h4>
        <p>Name, email, company, what you're trying to solve. Same as above. Stored in email. Used to assess fit and respond.</p>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>When you become a client</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>What we don't collect</h4>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>How we use it</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Who sees it</h3>

        <p>Your data lives in three places:</p>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginTop: '24px', marginBottom: '8px' }}>Our team</h4>
        <p>The people who need to see it to help you. Support requests, account issues, product feedback.</p>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginTop: '24px', marginBottom: '8px' }}>Service providers</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginTop: '24px', marginBottom: '8px' }}>Nobody else</h4>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>How long we keep it</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Your rights (GDPR)</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Security</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Changes to this policy</h3>

        <p>We might update this. When we do, we'll change the date at the top. Major changes? We'll email active clients.</p>

        <hr style={{ border: 'none', borderTop: '1px solid #e0e0e0', margin: '32px 0' }} />

        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Questions?</h3>
