  ...
  return (
    <PageLayout>
      <section id="terms" className="section active">
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>What we offer</h3>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px' }}>Product Suite</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>Direct Engagement</h4>
        <p>Custom consulting work. Fixed-price projects. Starting at £5,000. Terms agreed case by case before we start.</p>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>Free stuff</h4>
        <p>Athena (the AI chat), the website, articles. These come with no guarantees. Use at your own risk.</p>

        <hr style={{ border: 'none', borderTop: '1px solid #e0e0e0', margin: '32px 0' }} />

        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Product Suite Terms</h3>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px' }}>Pricing</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>Trial Period</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>Usage Requirements</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>Capacity Limits</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>What You Can't Do</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>Termination</h4>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Your Data and IP</h3>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px' }}>Your Work</h4>
        ...
        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>Our IP</h4>
        <p>The products, methodologies, prompts, frameworks—all ours. You get a license to use them. You don't get to copy them.</p>

        <h4 style={{ fontSize: '17px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px', marginTop: '24px' }}>Confidentiality</h4>
        <p>We won't share what you're working on. You don't share how our tools work. Mutual respect.</p>

        <hr style={{ border: 'none', borderTop: '1px solid #e0e0e0', margin: '32px 0' }} />

        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Liability</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Service Availability</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Payment Terms</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Changes to These Terms</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Governing Law</h3>
        ...
        <h3 style={{ fontFamily: '"Noto Sans", sans-serif', fontSize: '17px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginTop: '48px', marginBottom: '24px' }}>Contact</h3>
